    ...
    const renderList = () => {
        if (state) {
            return [
                ...
                // </li>,
                <>
                    {state.userType === 'STUDENT' && !state.isAdmin ? (
                        <li key="4">
                            <Link to="/create">Create Query</Link>
                        </li>
                    ) : null}
                </>,
                <li key="2">
            ...
            return [
                ...
                // <li key="57">
                // 	<Link to="/teacher/signup">Teacher Signup</Link>
                // </li>,
            ];
        }
    };
    ...
    return (
        <nav>
            <div className="nav-wrapper white">
                <Link to={state ? '/' : '/signin'} className="brand-logo left" style={{ marginLeft: 10 }}>
                    REC Placement Query Portal
                </Link>
